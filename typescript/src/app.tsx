...
class App extends React.Component<{}, {}> {
    ...
    createMockDataSource(): DataSource {
        const createField = (parent: DataTable, name: string, displayText: string, dataType: DataTypeEnum) => {
        ...
        const createRelationShip = (parent: DataTable, name: string, parentRelation: DataRelation, childRelation: DataRelation) => {
